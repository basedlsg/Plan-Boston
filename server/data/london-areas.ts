...
export const londonAreas: LondonArea[] = [
  ...
  },
  {
    ...
    neighbors: ["Green Park", "Soho", "Hyde Park", "Marylebone", "Piccadilly", "St. James's", "Oxford Street"],
  ...
  },
  {
    ...
    neighbors: ["Mayfair", "Fitzrovia", "Chinatown", "Covent Garden", "Oxford Street", "Piccadilly"],
  ...
  },
  {
    ...
    neighbors: ["Holland Park", "Notting Hill", "South Kensington", "Hammersmith"],
  ...
  },
  {
    ...
    neighbors: ["Fitzrovia", "Mayfair", "Regent's Park", "Baker Street"],
